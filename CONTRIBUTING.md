...
1. Fork the dev branch of the tirk repository.
...
1. When you're ready to make a pull request with your new feature or fix, please ensure the following before submitting:
  ...
  - Submit a [pull request][] to the dev branch of tikr.
...
```
git remote add upstream https://github.com/FatalBadgers/tirk.git
```
